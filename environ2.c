...
/**
 * copy_info - Create a copy of the name and value to create
 ...
 * @datash: Data structure containing the environment
...
/**
 * _setenv - Set an environment variable or alias.
 *
 * @datash: Data structure containing the environment name and value
 *
 * Return: 1 on success.
 */
